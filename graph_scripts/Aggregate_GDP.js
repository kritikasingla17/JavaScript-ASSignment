function F(){var margin = {top: 20, right: 10, bottom: 60, left: 90},
...
var yAxis = d3.svg.axis()
 ...
 d3.json("../json_files/Aggregate_population_and_GDP.json",function(error, data) {
 	 ...
 	 data.forEach(function(d){
 	 	d["Aggregate of GDP"]=+d["Aggregate of GDP"];
 	 	d["Continent"]=d["Continent"];
 	 	console.log(d["Aggregate of GDP"]);
 	 });

 data.sort(function(a,b){
 	return b["Aggregate of GDP"]-a["Aggregate of GDP"];
 });
