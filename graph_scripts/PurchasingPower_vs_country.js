function C(){var margin = {top: 20, right: 10, bottom: 100, left: 90},
...
var yAxis = d3.svg.axis()
 ...
 d3.json("../json_files/PurchasingPower_vs_country.json",function(error, data) {
   ...
   data.forEach(function(d){
    ...
    console.log(d["Purchasing Power in Billions ( Current International Dollar) - 2013"]);
   });
    ...
    .style("fill", function(d,i) { return 'rgb(20,20,20)'});
        ...
        svg.selectAll('text')
            ...
            .attr({
                ...
                "y": function(d){ return yScale(d["Purchasing Power in Billions ( Current International Dollar) - 2013"])+ 12; },
